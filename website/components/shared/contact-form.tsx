          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="contact-name" name="name" placeholder="Your name" className="field-with-icon" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="contact-email" name="email" type="email" placeholder="you@agency.com" className="field-with-icon" />
              </div>
            </div>
          </div>
          <div className="space-y-2">
            <label htmlFor="contact-message" className="text-sm font-medium">Message</label>
            <Textarea id="contact-message" name="message" placeholder="Tell us about your team, what you're evaluating, or what you want Crevo to help with." />
          </div>
          <SubmitButton />
        </form>
      </CardContent>
